...
type CityData = {
    ...
    name: string;
    center: { lat: number, lng: number };
    routes: Omit<BusRoute, 'cityId'>[];
}

type BusRoutesByCity = {
    cities: CityData[];
};


// This data is now structured by city and is used for seeding Firestore.
export const busRoutesByCity: BusRoutesByCity = {
    cities: [
        {
            id: 'indore',
            name: 'Indore',
